...
entity matrix_to_keynum is
  ...
  port (
    ...
    -- UART key stream
    ascii_key_o              : out   unsigned(7 downto 0);
    -- Bucky key list:
    -- 0 = left shift
    -- 1 = right shift
    -- 2 = control
    ...
    ascii_key_valid_o        : out   std_logic
  );
...
begin
  ...
  -- pace.
  current_kmm_inst : entity work.kb_matrix_ram
    port map (
      clka_i     => clk_i,
  ...
  debounce_kmm_inst : entity work.kb_matrix_ram
    port map (
      clka_i     => clk_i,
  ...
  last_kmm_inst : entity work.kb_matrix_ram
    port map (
      clka_i     => clk_i,
      addressa_i => ram_read_index,
